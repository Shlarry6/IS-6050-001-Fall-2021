...
multiply(5, 5, sendResultToConsole);
multiply(5, "ten", sendResultToConsole);
multiply(7, 4, saveResultToDatabase);
multiply("seven", "four", saveResultToDatabase);


const multiply2 = (error, number) => {
    if(error) {
        console.log(error);
    } else {
        let result = number * 5;
        console.log("number times 5 is: " + result);
    }
}

multiply(5, 5, multiply2);
multiply(5, "five", multiply2);
