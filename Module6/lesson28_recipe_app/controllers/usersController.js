...
module.exports = {
  ...
  // Old verion of token validation.  
  ...
  // Sign a new JWT for any authenticated user
    ...
    passport.authenticate("local", (errors, user) => {
      if (user) {
        let signedToken = jsonWebToken.sign(
          ...
          //check to see whether request came from /users/login
          //if so, store the token in the session and call next
  ...
  // Confirm the presence of a valid JWT passed in the request header
