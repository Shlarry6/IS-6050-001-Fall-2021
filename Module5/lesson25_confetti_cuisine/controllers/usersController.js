...
module.exports = {
  ...
  create: (req, res, next) => {
    ...
    // Use register function (added to our model by passport-local-mongoose) to create a new user record
  ...
  // Use passport's built-in authenticate function to handle user authentication
  ...
  // Call req.logout() to log user out.
  logout: (req, res, next) => {
    req.logout();
  ...
  verifyAuthentication: (req, res, next) => {
    if(req.isAuthenticated()) {
      ...
      req.flash("error", `You have to be signed in to view ${req.url}!`);
